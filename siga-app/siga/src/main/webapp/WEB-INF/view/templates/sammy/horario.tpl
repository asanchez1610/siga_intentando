	...
	<% if ( pregrado ) { %>
		<div class="tab-pane active" id="pregrado">
			...
			<h2>Horario de clases</h2>
                            <% if(ishorarioevento){ %>
                                <a class="btn btn-small" href="#/horario/prev/2"><i class="icon-arrow-left"></i> Anterior</a>
                                <a class="btn btn-small" href="#/horario"><i class="icon-calendar"></i> Actual</a>
                                <a class="btn btn-small" href="#/horario/next/1"><i class="icon-arrow-right"></i> Posterior</a>
                                <br>
                            <% }%>
